...
function menorMayor(numeros) {
    ...
    menor = numeros[numeros.length - 1];
    mayor = 0;
    newArray = [];
    ...
    newArray[0] = menor;
    newArray[newArray.length] = mayor;
    return newArray;
...
function pluck(array, propiedad) {
    ...
    nameProductos = array.map(function(e) {
        return e[propiedad];
    })
...
function crearClasePersona() {
    ...
    class Persona {
        ...
        getPromedioEdad() {
            ...
            return this.amigos.reduce(function(acc, e) {
                return acc + e.edad
